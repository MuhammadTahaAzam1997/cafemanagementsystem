...
if (isset($_REQUEST["submit"])) {
    ...
    $ins = "INSERT INTO seller (name,email,phone) VALUES ('$name','$email','$phone')";
...
<form action="seller.php" method="post">
  ...
  <div class="form-group">
    <label for="formGroupExampleInput3">Seller Email</label>
    <input type="text" class="form-control" name="email" id="formGroupExampleInput3" >
  </div>
  <div class="form-group">
    <label for="formGroupExampleInput4">Seller Phone</label>
    <input type="text" class="form-control" name="phone" id="formGroupExampleInput4" >
  </div>
  <div class="form-group">
